...
export default class MOIG {
    static getGrowingCost(cost: number, growthRate: number, ammount: number, growthType: GrowthTypes): number {
    ...
    static exponentialGrowth({cost, growthRate, ammount}: GrowthParams): number {
